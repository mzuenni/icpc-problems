// Has a ~ 5^(-5) chance of using more than 10 queries, and a ~ 35^(-5) chance of needing more than 40.
// To maximize success chances for 40 queries, set initial_query_cnt to 28.

#include <bits/stdc++.h>
using namespace std;
typedef long long ll;

constexpr ll initial_query_cnt = 5;
