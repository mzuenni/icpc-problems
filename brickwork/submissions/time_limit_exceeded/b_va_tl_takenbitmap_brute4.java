...
public class b_va_tl_takenbitmap_brute4 {
    public static void main(String[] args) {
        new b_va_tl_takenbitmap_brute4().run();
    }
...
//        System.err.println("Ready to random! " + (System.nanoTime() - start));
